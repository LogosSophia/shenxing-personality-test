...
MODULES = {"D": "第一部分：四域强度", "I": "第二部分：自然取向", "M": "第三部分：原则排序", "B": "第四部分：自然行为轴", "R": "第五部分：主从关系", "H": "第六部分：高低位辅助"}
...
QUESTIONS = [
    ...
    _pair("R01", "R", "下面哪项更符合你做事时的主从关系？", "我做规划、定目标、推动结果，主要是为了实现一个我内心已经看见的方向或抱负。", {"INTJ": 1}, "我判断方向、趋势和时机，主要是为了把事情做成、做大、建立成果和秩序。", {"ENTJ": 1}),
    _pair("R02", "R", "下面哪项更符合你影响他人时的主从关系？", "我经营关系、表达共情，是为了把人带向我看见的方向。", {"INFJ": 1}, "我判断趋势和方向，是为了更好地凝聚人、影响人、连接人。", {"ENFJ": 1}),
    _pair("R03", "R", "下面哪项更符合你面对秩序和结果时的主从关系？", "我管理目标和责任，是为了让已有秩序、经验和流程稳定延续。", {"ISTJ": 1}, "我使用经验和流程，是为了更有效地管理、推进和达成结果。", {"ESTJ": 1}),
    _pair("R04", "R", "下面哪项更符合你维系关系时的主从关系？", "我照顾关系和回应他人，是为了守护熟悉、稳定、可靠的生活世界。", {"ISFJ": 1}, "我使用传统、习惯、礼节和熟悉方式，是为了让关系场更稳定。", {"ESFJ": 1}),
    _pair("R05", "R", "下面哪项更符合你思考和创造时的主从关系？", "我想到很多可能性，主要是为了把一个问题想清楚、想透。", {"INTP": 1}, "我使用逻辑分析，主要是为了打开更多可能性和新玩法。", {"ENTP": 1}),
    _pair("R06", "R", "下面哪项更符合你选择道路时的主从关系？", "我尝试很多可能，主要是为了找到真正符合自己的道路。", {"INFP": 1}, "我会用自己的喜好和价值感，去选择并点燃新的可能。", {"ENFP": 1}),
    _pair("R07", "R", "下面哪项更符合你处理现场时的主从关系？", "我进入现实操作，主要是为了理解机制、验证判断。", {"ISTP": 1}, "我使用分析和判断，主要是为了更快、更准地处理现场。", {"ESTP": 1}),
    _pair("R08", "R", "下面哪项更符合你行动和体验时的主从关系？", "我追求体验、行动和审美，主要是为了表达真实的自己。", {"ISFP": 1}, "我使用自己的真实感和喜好，主要是为了选择、强化、点亮当下体验。", {"ESFP": 1}),
