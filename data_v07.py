...
def _stress(qid, prompt):
    return _single(qid, "X", prompt, [
        {"key": "A", "text": "先压成结构、判断、主线和系统解释，让一切重新变得可理解。", "scores": {"TN": 1}},
        {"key": "B", "text": "先明确目标、步骤、现场反馈和可控处理，让局面重新被接管。", "scores": {"TS": 1}},
        {"key": "C", "text": "先守住意义、可能、真实感和人的理解，不让外部压力改写内在判断。", "scores": {"NF": 1}},
        {"key": "D", "text": "先回到具体生活、稳定关系、身体感和实际体验，让人和状态先安顿下来。", "scores": {"SF": 1}},
    ], "压力协同")
...
QUESTIONS = [
    ...
    _stress("X01", "当局面逼近、压力开始上来时，我更自然会："),
    _stress("X02", "当别人用结果、效率、评价或情绪压过来时，我更容易："),
    _stress("X03", "当我被迫处理一个失控问题时，我更像："),
