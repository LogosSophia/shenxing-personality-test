...
HEADERS = [
    ...
    "chosen_monarch", "second_monarch", "monarch_gap", "branch_gap",
    "monarch_axis", "monarch_axis_centered", "monarch_marshal",
    "chancellor_centered", "guard_centered", "emperor_centered",
    "branch_score", "branch_score_centered", "positions_json",
    "monarch_axis_json", "monarch_axis_centered_json", "branch_scores_json",
    "branch_scores_centered_json", "detail_json",
]
