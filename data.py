...
X_Ti_01	第六部分：元帅极限反相	元帅	Ti	自洽性与逻辑性（可理解性）	在极端失望时，我会产生一种冲动：直接判定这件事或这个人不成立。	Ti_Marshal
X_Ti_02	第六部分：元帅极限反相	元帅	Ti	自洽性与逻辑性（可理解性）	事后回看，我最冷的反应常常是取消某个对象继续被讨论的资格。	Ti_Marshal
X_Te_01	第六部分：元帅极限反相	元帅	Te	建构性与目的性	在极端失望时，我会产生一种冲动：用规则、程序、资源或后果切断对方。	Te_Marshal
X_Te_02	第六部分：元帅极限反相	元帅	Te	建构性与目的性	事后回看，我最硬的反应常常是把关系或问题直接推进清算流程。	Te_Marshal
X_Ni_01	第六部分：元帅极限反相	元帅	Ni	涌现性与压缩性	在极端失望时，我会产生一种冲动：判定一切已经没有未来。	Ni_Marshal
X_Ni_02	第六部分：元帅极限反相	元帅	Ni	涌现性与压缩性	事后回看，我最重的反应常常是用终局感封死某件事。	Ni_Marshal
X_Ne_01	第六部分：元帅极限反相	元帅	Ne	创生性与可能性	在极端失望时，我会产生一种冲动：打开混乱，让原来的秩序无法继续控制。	Ne_Marshal
X_Ne_02	第六部分：元帅极限反相	元帅	Ne	创生性与可能性	事后回看，我最散开的反应常常是让局面分叉到谁都难以收束。	Ne_Marshal
X_Si_01	第六部分：元帅极限反相	元帅	Si	守恒性与不变性	在极端失望时，我会产生一种冲动：把旧账、旧伤和过去全部翻出来。	Si_Marshal
X_Si_02	第六部分：元帅极限反相	元帅	Si	守恒性与不变性	事后回看，我最难放下的反应常常是证明这一切从未真正过去。	Si_Marshal
X_Se_01	第六部分：元帅极限反相	元帅	Se	在场性与现实性	在极端失望时，我会产生一种冲动：直接用现实动作把局面撕开。	Se_Marshal
X_Se_02	第六部分：元帅极限反相	元帅	Se	在场性与现实性	事后回看，我最强烈的反应常常是立刻到场、离场、摔门或行动。	Se_Marshal
X_Fi_01	第六部分：元帅极限反相	元帅	Fi	本真性与统一性	在极端失望时，我会产生一种冲动：不再讲任何道理，只守住底线。	Fi_Marshal
X_Fi_02	第六部分：元帅极限反相	元帅	Fi	本真性与统一性	事后回看，我最决绝的反应常常是以尊严、本真和不再妥协完成截断。	Fi_Marshal
X_Fe_01	第六部分：元帅极限反相	元帅	Fe	关联性与互系性	在极端失望时，我会产生一种冲动：把对方从我的共同世界中移出。	Fe_Marshal
X_Fe_02	第六部分：元帅极限反相	元帅	Fe	关联性与互系性	事后回看，我最强的反应常常是撤回回应，让某人不再属于我的关系场。	Fe_Marshal
"""
